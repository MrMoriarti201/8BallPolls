...
public class AS_SetupWindow : EditorWindow
{
	...
	void Awake() 
	{
		...
		additionalFields.Add (new AS_MySQLField ("Country", AS_MySQLFieldType.Varchar, false, false, "The user's Country of Residence"));
	}
	...
	string _phpScriptsLocation = AS_Credentials.phpScriptsLocation;
	...
	void CredentialsGUI () {
		...
		if (GUI.Button (new Rect (420, 330, 120, 30), "Next")){
            ...
            if (!_phpScriptsLocation.Contains(cmp))
            {
                ...
                Debug.LogWarning("Automatically added 'http://' in front of the php script location..!");
            }

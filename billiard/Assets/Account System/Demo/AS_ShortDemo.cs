...
public class AS_ShortDemo : MonoBehaviour
{
    ...
    void RegistrationAttempted(string message)
    {
        ...
        Debug.Log("AccountSystem: Attempting to Register the following account info:\n" + accountInfo.ToReadableString());
    ...
    void OnDownload(string message)
    {
        ...
        Debug.Log("AccountSystem: Downloaded Successfully the following account info:\n" + accountInfo.ToReadableString());
    ...
    void OnUpload(string message)
    {
        ...
        Debug.Log("AccountSystem: Uploaded Successfully the following account info:\n" + accountInfo.ToReadableString());

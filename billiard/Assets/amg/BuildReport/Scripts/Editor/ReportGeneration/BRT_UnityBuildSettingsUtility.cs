...
#if !UNITY_5
		settings.StripPhysicsCode = PlayerSettings.stripEngineCode;
#endif
...
//		settings.WebPlayerDeployOffline = EditorUserBuildSettings.webPlayerOfflineDeployment;
	...
	public static void PopulateMobileSettings(UnityBuildSettings settings)
	{
		...
		settings.iOSTargetResolution = Screen.currentResolution.ToString ();//PlayerSettings.iOS.targetResolution.ToString();
